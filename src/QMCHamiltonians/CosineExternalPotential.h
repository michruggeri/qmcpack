...
#ifndef QMCPLUSPLUS_COSINE_EXTERNAL_POTENTIAL_H
#define QMCPLUSPLUS_COSINE_EXTERNAL_POTENTIAL_H
...
{
struct CosineExternalPotential : public OperatorBase
{
  //data members
  RealType intensity;
  RealType qx;
  ...
  CosineExternalPotential(ParticleSet& P) : Ps(P)
  {
    set_energy_domain(potential);
    one_body_quantum_domain(P);
  }

  ~CosineExternalPotential() {}
