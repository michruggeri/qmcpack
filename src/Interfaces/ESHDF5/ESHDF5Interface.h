...
*/
  ...
  {
  public:
    ESHDF5Interface(Communicate* mycomm):ESInterfaceBase(mycomm), myComm(mycomm), H5FileName("aaa.h5"),H5FileID(0),box_changed(false), pos_changed(false)        {ifacename = "ESHDF5";};
    ESHDF5Interface():H5FileName("aaa.h5"),H5FileID(0),box_changed(false), pos_changed(false)        {ifacename = "ESHDF5";};
    ~ESHDF5Interface(){};
