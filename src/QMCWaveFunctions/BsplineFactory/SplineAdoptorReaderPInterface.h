 ...
 */
#ifndef QMCPLUSPLUS_EINSPLINE_ADOPTOR_READERP_H_INTERFACE
#define QMCPLUSPLUS_EINSPLINE_ADOPTOR_READERP_H_INTERFACE
...
struct SplineAdoptorReaderInterface : public BsplineReaderInterface
{
  ...
  ~SplineAdoptorReaderInterface() { clear(); }
