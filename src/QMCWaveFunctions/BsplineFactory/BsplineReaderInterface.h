 ...
 */
#ifndef QMCPLUSPLUS_BSPLINE_READER_BASE_H_INTERFACE
#define QMCPLUSPLUS_BSPLINE_READER_BASE_H_INTERFACE
...
struct BsplineReaderInterface
{
  ...
  EinsplineSetBuilderInterface* mybuilder;
  ///communicator
  Communicate* myComm;
  ///mesh size
  ...
  BsplineReaderInterface(EinsplineSetBuilderInterface* e);

  virtual ~BsplineReaderInterface();
